...
public class CustomRedisAutoConfiguration {
	...
	public static class RedisConnectionConfiguration {
		...
		public RedisConnectionConfiguration(RedisProperties properties, RedisSentinelConfiguration sentinelConfiguration, RedisClusterConfiguration clusterConfiguration) {
