...
public class RSAUtil {
     ...
     * @throws RsaException
     */
	public static String rsaPublicEncrypt(String content, String publicKey, String charset) throws RsaException {
		try {
	...
	//公钥解密
	public static String rsaPublicDecrypt(String content, String publicKey, String charset) throws RsaException {
		try {
			PublicKey pubKey = getPublicKeyFromX509(RSA_ALGORITHM, publicKey);
			Cipher cipher = Cipher.getInstance(RSA_ALGORITHM);
     ...
     * @throws RsaException
     */
	public static String rsaPrivateDecrypt(String content, String privateKey, String charset) throws RsaException {
		try {
	...
	//私钥加密
	public static String rsaPrivateEncrypt(String content, String privateKey, String charset) throws RsaException {
		try {
			PrivateKey priKey = getPrivateKeyFromPKCS8(RSA_ALGORITHM, privateKey);
			Cipher cipher = Cipher.getInstance(RSA_ALGORITHM);
