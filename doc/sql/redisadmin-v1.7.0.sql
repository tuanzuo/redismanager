...
CREATE TABLE `t_redis_config_ext` (
  ...
  `rconfig_id` varchar(32) COLLATE utf8_bin NOT NULL COMMENT '关联的配置id',
...
INSERT INTO `t_config` (`service_name`, `config_type`, `config_key`, `key_name`, `content`, `version`, `note`, `creater`, `create_time`, `updater`, `update_time`, `if_del`) VALUES ('redismanagerweb', 30, 'CONFIG_LIST_API', '查询配置列表请求限流', '{\"key\":\"CONFIG_LIST_API\",\"name\":\"查询配置列表请求限流\",\"permits\":1,\"qps\":200.0,\"timeout\":0,\"unit\":\"MICROSECONDS\"}', 12, NULL, 'superadmin', '2021-04-23 22:46:53', 'superadmin', '2021-08-07 22:52:10', 0);
INSERT INTO `t_config` (`service_name`, `config_type`, `config_key`, `key_name`, `content`, `version`, `note`, `creater`, `create_time`, `updater`, `update_time`, `if_del`) VALUES ('redismanagerweb', 30, 'CAPTCHA_API', '验证码限流', '{\"key\":\"CAPTCHA_API\",\"name\":\"验证码限流\",\"permits\":1,\"qps\":100.0,\"timeout\":0,\"unit\":\"MICROSECONDS\"}', 20, NULL, 'superadmin', '2021-04-24 19:26:43', 'superadmin', '2021-08-07 22:53:52', 0);
